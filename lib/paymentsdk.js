...
PaymentSDK.prototype.authorize = function()
{
  ...
  //console.log("\nPayment Req: " + req);
  this.interswitch.send("api/v3/purchases", "POST", req, callback);
}
...
PaymentSDK.prototype.validateCard = function()
{
  ...
  //console.log("\nValidate Req: " + req);
  this.interswitch.send("api/v3/purchases/validations", "POST", req, callback);
}
...
PaymentSDK.prototype.verifyOTP = function()
{
  ...
  this.interswitch.send("api/v3/purchases/otps/auths", "POST", req, callback);
}
...
PaymentSDK.prototype.getStatus = function()
{
  ...
  this.interswitch.send("api/v3/purchases", "GET", null, httpHeader, callback);
}
